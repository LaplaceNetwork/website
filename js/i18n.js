var i18n = {
  ...
  en: {
    ...
    datasee:
      "Supporter of data discovery, data authorization and data exchange",
    base: "Infrastructure",
    tranlink: "Cross-chain Abstract Layer",
    mainplatform: "Neutral mainnet platform",
    unionplatform: "Avert the risks of a single platform",
    coredata: "Core Data Exchange Protocol Group",
    ecohandle: "Management Plan for Partners in the Ecosystem",
    "e-com": "Token economics basis",
    ...
    q43: "Recruitment of ecological partners from whole network",
    ln: "",
    seeall: "",
    "questions&answers": [
      {
